      ...
      <div className="max-w-md w-full">
        <div className="bg-white rounded-lg shadow-xl p-8">
          <div className="text-center mb-8">
            ...
            <h2 className="text-xl font-semibold text-gray-900">Join the Movement</h2>
          ...
          <div className="mt-6 bg-green-50 p-4 rounded-md">
            <h3 className="text-sm font-medium text-green-800 mb-2">🌿 Welcome Benefits</h3>
            <ul className="text-xs text-green-700 space-y-1">
              <li>• Start with 0 Green Points</li>
              <li>• Earn points by reporting waste and cleaning areas</li>
              <li>• Redeem points at partner stores</li>
              <li>• Join community cleanup drives</li>
            </ul>
          </div>
